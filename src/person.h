...
public:
  ...
  Person(const std::string& name, const std::string& email, const std::string& current_city,
    const std::string& main_desire_city);
  
  Person(const std::string& name, const std::string& email, const std::string& current_city,
    const std::string& main_desire_city, const std::string& second_option_city);
